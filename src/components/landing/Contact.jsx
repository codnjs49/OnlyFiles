    ...
    <Container id="contact">
      <Wrapper>
        <FormContainer>
          ...
          <Title>Contact Us for Enquiries!</Title>
          <Span>
          We're here to assist you with any questions or concerns you might have. <br/>
          If you need more information about our products/services or have a specific enquiry, <br/>
          don't hesitate to reach out to us. <br/>
          Leave us your email, and we'll get back to you as soon as possible!
          </Span>
        </FormContainer>
        <AddressContainer>
          <AddressItem>
