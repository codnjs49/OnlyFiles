...
const OTP = () => {
  ...
  //   // });
  //   await instance.get(`user/login/+${phone}`)
  //     .then((response) => {
  //       console.log("Response.data.result: ", response.data.results);
  //       console.log("Response.data: ", response.data);
  //       console.log("Reponse", response);
  //       const data = response.data.results;
  //       const userInfoList = data.map((entry) => ({
  //         uid: entry.u_id,
  //         email: entry.email,
  //         firstname: entry.f_name,
  //         lastname: entry.l_name,
  //         username: entry.username,
  //         type: entry.usertype,
  //         phone: entry.phone_number,

  //       }));
  //       setUser(userInfoList[0]);
